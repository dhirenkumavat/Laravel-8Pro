...
class Project extends BaseController
{
    ...
    public function getProjectList()
    {
        ...
        $uriMethod = $this->input->post('uriMethod');
        $userlist = $this->user_model->getAllActiveUser();
        $county = $this->input->post('county');

        if (!empty($county)) {
            $this->site->setCountyMethod($county);
        }
        if (!empty($uriMethod)) {
            $this->site->setUriMethod($uriMethod);
        }
        if (!empty($lead_id)) {
        ...
        foreach ($getOrderInfo as $element) {
            ...
            if ($project_list_stage == 2 && ($element['dueDate'] == "0000-00-00" || $element['dueDate'] == "" || $element['dueDate'] == "01/01/1970")) {
                $dueDate = "";
            } else if ($element['dueDate'] == "0000-00-00" || $element['dueDate'] == "" || $element['dueDate'] == "01/01/1970") {
                $dueDate = date('m/d/Y');
            } else {
                $dueDate = date('m/d/Y', strtotime($element['dueDate'])) . " " . $element['dueTime'];
            }
            ...
            if ($element['bid_price'] != "" || $element['bid_price'] != NULL) {
                ...
                $bidprice = money_format('%.0n', str_replace('$', '', str_replace(',', '', $element['bid_price'])));
            } else {
                $bidprice = "";
            }
            ...
            $bidPriceCall = "inlineEdit('bid_price','" . $element['bid_price'] . "','" . $element['projectId'] . "')";
            ...
            $dueDateCall = "inlineEdit('dueDate','" . $dueDate . "','" . $element['projectId'] . "')";
            $estimatorCall = "inlineEditEstimator('estimator','" . $estimator_name . "','" . $element['projectId'] . "')";
            $addressCall = "inlineEditAdd('address','" . $element['address'] . "','" . $element['projectId'] . "')";
            $romCall = "inlineEdit('rom','" . $romVal . "','" . $element['projectId'] . "')";
            //$contractCall = "inlineEditAdd('contract','".$element['contract']."','".$element['projectId']."')";

            $method = $uriMethod; //$this->router->fetch_method();
            $color = "";
            ...
            $actionButtons = '<a title="Status" onclick="statusModal(' . $element['projectId'] . ')" href="javascript:void(0)" class="btn btn-rounded bg-warning btn-xs"> <i class="fa fa-pencil1-alt">S</i> </a><a href="' . base_url() . 'editProject/' . $element['projectId'] . '" class="btn btn-rounded btn-sm bg-warning"> <i class="fa fa-pencil-alt"></i> </a>
                ...
                <a title="Copy" href="#" data-leadid="' . $element['projectId'] . '" onClick="copy_project(' . $element['projectId'] . ')" class="btn btn-rounded bg-danger btn-sm copyLead"> <i class="fa fa-copy"></i> </a>';
            $t = 0;
            // print_r($roleArray);
            // echo $user_level_where_condition ." ". $method;die;
            if (empty($user_level_where_condition)) {
                $actionButtons = '<a title="Status" onclick="statusModal(' . $element['projectId'] . ')" href="javascript:void(0)" class="btn btn-rounded bg-warning btn-xs"> <i class="fa fa-pencil1-alt">S</i> </a><a href="' . base_url() . 'editProject/' . $element['projectId'] . '" class="btn btn-rounded btn-sm bg-warning" target="_blank"> <i class="fa fa-pencil-alt"></i> </a>
                <a href="#" data-leadid="' . $element['projectId'] . '" onClick="delete_project(' . $element['projectId'] . ')" class="btn btn-rounded bg-danger btn-sm deleteList"> <i class="fa fa-trash-alt"></i> </a>
                <a title="Copy" href="#" data-leadid="' . $element['projectId'] . '" onClick="copy_project(' . $element['projectId'] . ')" class="btn btn-rounded bg-danger btn-sm copyLead"> <i class="fa fa-copy"></i> </a>';
                $t = 1;
                ...
                <a title="Copy" href="#" data-leadid="' . $element['projectId'] . '" onClick="copy_project(' . $element['projectId'] . ')" class="btn btn-rounded bg-danger btn-sm copyLead"> <i class="fa fa-copy"></i> </a>';
                $t = 0;
            } else if (!empty($roleArray) && in_array($element['sales'], $roleArray)) {
                $actionButtons = '<a title="Status" onclick="statusModal(' . $element['projectId'] . ')" href="javascript:void(0)" class="btn btn-rounded bg-warning btn-xs"> <i class="fa fa-pencil1-alt">S</i> </a>
                <a href="' . base_url() . 'editProject/' . $element['projectId'] . '" class="btn btn-rounded btn-sm bg-warning" target="_blank"> <i class="fa fa-pencil-alt"></i> </a>
                <a href="#" data-leadid="' . $element['projectId'] . '" onClick="delete_project(' . $element['projectId'] . ')" class="btn btn-rounded bg-danger btn-sm deleteList"> <i class="fa fa-trash-alt"></i> </a>
                <a title="Copy" href="#" data-leadid="' . $element['projectId'] . '" onClick="copy_project(' . $element['projectId'] . ')" class="btn btn-rounded bg-danger btn-sm copyLead"> <i class="fa fa-copy"></i> </a>';
                $t = 1;
            } elseif (!empty($roleArray) && !in_array($element['sales'], $roleArray)) {
                $actionButtons = '<a title="View Project Details" href="' . base_url() . 'viewProjectDetails/' . $element['projectId'] . '" class="btn btn-rounded bg-warning btn-xs"> <i class="fa fa-eye"></i> </a>';
                $t = 0;
            }

            if ($t == 1) {
                $filesystem_id = '<span id="filesystem_id_' . $element['projectId'] . '"></span> <p class="p-l-10" id="edit_filesystem_id_' . $element['projectId'] . '" onclick="' . $filesystemCall . '">' . $element['filesystem_id'] . '</p>';
            } else {
                $filesystem_id = '<span id="filesystem_id_' . $element['projectId'] . '"></span> <p class="p-l-10" id="edit_filesystem_id_' . $element['projectId'] . '">' . $element['filesystem_id'] . '</p>';
            }
            ...
            if ($t == 1) {
                $bid_price = '<span id="bid_price_' . $element['projectId'] . '"></span> <p class="p-l-10" id="edit_bid_price_' . $element['projectId'] . '" onclick="' . $bidPriceCall . '">' . $bidprice . '</p>';
            } else {
                $bid_price = '<span id="bid_price_' . $element['projectId'] . '"></span> <p class="p-l-10" id="edit_bid_price_' . $element['projectId'] . '">' . $bidprice . '</p>';
            }


            if ($t == 1) {
                $projectName = '<span id="projectName_' . $element['projectId'] . '"></span><p class="p-l-10" id="edit_projectName_' . $element['projectId'] . '" onclick="' . $projectNameCall . '"><a href="' . base_url() . 'editProject/' . $element['projectId'] . '" target="_blank"><b>' . $element['projectName'] . '</b></a></p>';
            } else {
                $projectName = '<span id="projectName_' . $element['projectId'] . '"></span><p class="p-l-10" id="edit_projectName_' . $element['projectId'] . '"><a href="javascript:void(0)"><b>' . $element['projectName'] . '</b></a></p>';
            }

            if ($t == 1) {
                $company = '<span class="p-l-10">' . '<a href="' . base_url() . 'editProject/' . $element['projectId'] . '" style=' . $color . ' target="_blank">' . ucfirst($element['company']) . '</a>' . '</span>';
            } else {
                $company = '<span class="p-l-10">' . '<a href="javascript:void(0)" style=' . $color . '>' . ucfirst($element['company']) . '</a>' . '</span>';
            }

            if ($t == 1) {
                $estStartDate = '<span class="p-l-10">' . '<a href="' . base_url() . 'editProject/' . $element['projectId'] . '" target="_blank">' . $element['estStartDate'] . '</a>' . '</span>';
            } else {
                $estStartDate = '<span class="p-l-10">' . '<a href="javascript:void(0)" style=' . $color . '>' . $element['estStartDate'] . '</a>' . '</span>';
            }

            if ($t == 1) {
                $rom = '<span id="rom_' . $element['projectId'] . '"></span><p class="p-l-10" id="edit_rom_' . $element['projectId'] . '" onclick="' . $romCall . '">' . $romVal . '</a></p>';
            } else {
                $rom = '<span id="rom_' . $element['projectId'] . '"></span><p class="p-l-10" id="edit_rom_' . $element['projectId'] . '"><a href="javascript:void(0)">' . $romVal . '</a></p>';
            }



            if ($t == 1) {
                $dueDate = '<span style="display:none;">' . strtotime(date("m/d/Y", strtotime($dueDate))) . '</span><span id="dueDate_' . $element['projectId'] . '"></span><p class="p-l-10" id="edit_dueDate_' . $element['projectId'] . '" onclick="' . $dueDateCall . '">' . $dueDate . '</p>';
            } else {
                $dueDate = '<span style="display:none;">' . strtotime(date("m/d/Y", strtotime($dueDate))) . '</span><span id="dueDate_' . $element['projectId'] . '"></span><p class="p-l-10" id="edit_dueDate_' . $element['projectId'] . '">' . $dueDate . '</p>';
            }

            if ($t == 1) {
                $jobWalkTime = '<span style="' . $hide_job_walk . '" id="jobWalkTime_' . $element['projectId'] . '"></span><p  class="p-l-10" id="edit_jobWalkTime_' . $element['projectId'] . '" onclick="' . $jobWalkTimeCall . '">' . $element['jobWalkTime'] . '</p>
                <input type="hidden" name="createdDtm" id="createdDtm_' . $element['projectId'] . '" value="' . $element['createdDtm'] . '">';
            } else {
                $jobWalkTime = '<span style="' . $hide_job_walk . '" id="jobWalkTime_' . $element['projectId'] . '"></span><p  class="p-l-10" id="edit_jobWalkTime_' . $element['projectId'] . '">' . $element['jobWalkTime'] . '</p>
                <input type="hidden" name="createdDtm" id="createdDtm_' . $element['projectId'] . '" value="' . $element['createdDtm'] . '">';
            }

            if ($t == 1) {
                $address = '<span id="address_' . $element['projectId'] . '"></span><p class="p-l-10" id="edit_address_' . $element['projectId'] . '" onclick="' . $addressCall . '">' . $element['address'] . '</p>';
            } else {
                $address = '<span id="address_' . $element['projectId'] . '"></span><p class="p-l-10" id="edit_address_' . $element['projectId'] . '">' . $element['address'] . '</p>';
            }

            if ($t == 1) {
                $estimator = '<span id="estimator_' . $element['projectId'] . '"></span><p class="p-l-10" id="edit_estimator_' . $element['projectId'] . '" onclick="' . $estimatorCall . '">' . $estimator_name . '</p>';
            } else {
                $estimator = '<span id="estimator_' . $element['projectId'] . '"></span><p class="p-l-10" id="edit_estimator_' . $element['projectId'] . '">' . $estimator_name . '</p>';
            }
            ...
            $dataArray[] = array(
                ...
                '<span style="' . $is_show_bidprice . '">' . $bid_price . '</span>',
    ...
    public function projectListing()
    {
        if ($this->isAdmin() == true) {
            ...
            $data['counties'] = $this->project_model->getCounty();
            ...
            $data['pageTitle'] = $this->global['pageTitle'] = 'Amplify : Projects';
            $data['PageEdit'] = $this->global['PageEdit'] = 'All Projects';
            $data['roleArray'] = array();

            $data['leadRecords'] = $this->project_model->leadListing();
            //print_r($data['leadRecords']);die;
            ini_set('display_errors', 0);
            $this->load->view("includes/header", $this->global);
            $this->load->view("projects/projectsList.php", $data);
            $this->load->view("includes/footer");

            //$this->loadViews("projects/projects.php", $this->global, $data, null);
        }
    }
    ...
    public function prospectsProjectListing()
    {
        if ($this->isAdmin() == true) {
            ...
            $user_level_where_condition = manage_user_level_condition();
            $data['user_level_where_condition'] = $user_level_where_condition;
            $data['roleArray'] = array();
    ...
    public function percentProjectListing()
    {
        if ($this->isAdmin() == true) {
            ...
            $user_level_where_condition = manage_user_level_condition();
            $roleArray = manage_user_level2();
            $data['roleArray'] = explode(",", $roleArray);
    ...
    public function notBid()
    {
        if ($this->isAdmin() == true) {
            ...
            $data['sales_rep'] = $sales_rep;
            $data['stageId'] = $stageId;
            $config['total_rows'] = $this->project_model->leadListingCount(14);
            $data['counties'] = $this->project_model->getCounty();
            $data['total_count'] = $config['total_rows'];
            $config['suffix'] = '';
            //$data['sales_rep'] = $this->user_model->getSalesRep();
            ...
            $data['project_list_stage'] = 14;
            $this->global['pageTitle'] = 'Amplify : Projects';
            $this->global['PageEdit'] = 'Projects: Not Bid';
            $data['leadRecords'] = $this->project_model->leadListing(14);
            $roleArray = manage_user_level2();
            $data['roleArray'] = explode(",", $roleArray);
            //print_r($data['roleArray']);die;
            $user_level_where_condition = manage_user_level_condition();
    ...
    public function getProjectContact()
    {
        ...
        if ($projectId == "") {
            ...
            if (count($contactDtl) > 0) {
                echo json_encode(array('status' => true, 'result' => $contactDtl));
                die;
            } else {
                echo json_encode(array('status' => false));
                die;
    ...
    public function getProjByStage()
    {
        ...
        if ($stageID == "") {
            ...
            if (count($projectList) > 0) {
                echo json_encode(array('status' => true, 'result' => $projectList));
                die;
            } else {
                echo json_encode(array('status' => false));
                die;
    ...
    public function addNewProject()
    {
        if ($this->isAdmin() == true) {
            ...
            $data['userList'] = $this->project_model->getUserList();
        ...
        if ($this->isAdmin() == true) {
            ...
            if ($this->form_validation->run() == false) {
                ...
                if (!empty($bidArray)) {
                    ...
                    $this->project_model->updateBidsOnAdd($result, $bidArray, $userID, $bidRandomIDVal, $buildingSf);
                }

                $history = array(
                    'projectId' => $result, 'stageId' => $stageId, 'createdDtm' =>  date('Y-m-d H:i:s'),
                    ...
                    foreach ($contactArr as $contactArrVal) {
                        ...
                        if (!empty($checkClientContact) && isset($checkClientContact)) {
                            $updateContactData   =  array(
                                ...
                                'assigned_to' =>  $contactArrVal->assignedTo,
     ...
     */
    public function viewProjectDetails($projectId = null)
    {
        if ($this->isAdmin() == true) {
            $this->loadThis();
        } else {
            ...
            $data['leadInfo'] = $this->project_model->getLeadInfo($projectId);
            $data['userList'] = $this->project_model->getUserList();
            if (empty($data['leadInfo'])) {
                redirect('projectListing');
            }
            $data['clientsInfo'] = $this->project_model->getClientsInfo();
            $data['bidInfo'] = $this->project_model->getBidByProjectIdForView($projectId);
            ...
            if ($contacInfo) {
                foreach ($contacInfo as $contact) {
                    ...
                    $contactArr['assignedTo'] =   $contact->assigned_to;
                    $contactArr['conatctPrimary'] =   $contact->is_primary;
                    $contactArr['contactName'] = htmlentities($contact->contact_name, ENT_QUOTES);
            ...
            $this->global['pageTitle'] = 'Amplify : Project Detail';
            $this->global['PageEdit'] = "Project Detail: #" . $data['leadInfo']->filesystem_id . " - " . $data['leadInfo']->projectName;

            $this->loadViews('projects/project_details.php', $this->global, $data, null);
        }
    }
    ...
    public function editProject($projectId = null)
    {
        if ($this->isAdmin() == true) {
            ...
            $link_array = explode('/', $refer);
            $method = end($link_array);
            $data['method'] = $method;
            $data['user_level_where_condition'] = $user_level_where_condition; //print_r($data['clientInfoJson']);die;
    ...
    public function editProjectSubmit()
    {
        ...
        if ($this->isAdmin() == true) {
            ...
            if ($this->form_validation->run() == false) {
                ...
                $history = array(
                    'projectId' => $projectId, 'stageId' => $stage, 'createdDtm' =>  date('Y-m-d H:i:s'),
                    'updatedDtm'    =>  date('Y-m-d H:i:s')
                );
    ...
    function check_project_file_id($filesystem_id)
    {
        ...
        if ($filesystem_id != "") { //echo $filesystem_id ;
    ...
    public function inLineProjectUpdate()
    {
        ...
        if ($fieldname == "projectName") {
            ...
            if ($res != 0) {
                echo json_encode(array('status' => false, 'msg' => 'Project name is already exist'));
                die;
            }
        }
        ...
        if ($fieldname == "filesystem_id") {
            ...
            if ($res != 0) {
                echo json_encode(array('status' => false, 'msg' => 'Job number is already exist'));
                die;
            }
        }

        if ($fieldval == "") {
            echo json_encode(array('status' => false, 'msg' => 'Please add value'));
            die;
        } else {
    ...
    function saveClient()
    {
        ...
        $buisnessType = $this->input->post('buisnessType');
        if ($clientName == "") {
            echo json_encode(array('status' => false, 'msg' => "Please enter company name"));
            die;
        }
        if ($address == "") {
            echo json_encode(array('status' => false, 'msg' => "Please enter address"));
            die;
        }
        if ($phNo == "") {
        ...
        if ($buisnessType == "") {
            echo json_encode(array('status' => false, 'msg' => "Please enter Buisness Type"));
            die;
        } else {

            $clientExist = $this->project_model->checkClientExist($clientName, $client_id);
            if (!empty($clientExist)) {
                echo json_encode(array('status' => false, 'msg' => "This company already exist"));
                die;
            } else {
                ...
                if ($clientaddresult > 0) {
                    echo json_encode(array('status' => true, 'result' => $clientaddresult));
                    die;
                } else {
                    echo json_encode(array('status' => false, 'msg' => "Something is wrong"));
                    die;
    ...
    function editNotes()
    {
        $notesArray = $this->input->post();
        $this->project_model->editNotes($notesArray);
        echo json_encode(array('status' => true, 'notes' => $notesArray['notes']));
        die;
    }
    ...
    function clientContact()
    {
        ...
        if ($client_id == "") {
            ...
            if (count($clientContacts) > 0) {
                echo json_encode(array('status' => true, 'result' => $clientContacts));
                die;
            } else {
                echo json_encode(array('status' => false));
                die;
...
*/
    ...
    function editBid()
    {
        ...
        $bidArray['bidPrice'] = str_replace('$', '', str_replace(',', '', $this->input->post('bidPrice')));
        $bidArray['userId'] = $this->session->userdata['userId'];
        echo $this->project_model->editBid($bidArray);
    }
    ...
    function editContractingBid()
    {
        ...
        $bidArray['bidPrice'] = str_replace('$', '', str_replace(',', '', $bidPrice));
        $bidArray['userId'] = $this->session->userdata['userId'];
        $this->project_model->editContractingBid($bidArray);
        echo json_encode(array('status' => true, 'bidPrice' => $bidPrice));
    }
    ...
    function getBidAjaxOnEdit()
    {
        $userId = $this->session->userdata['userId'];
        $randomBidId = $this->input->get('bidRandomId');
        $projectId = $this->input->get('projectId');
        $isUpdate = $this->input->get('isUpdate');
        $array = $this->project_model->getBidOnEdit($userId, $randomBidId, $projectId, $isUpdate);
        echo json_encode($array);
    }
