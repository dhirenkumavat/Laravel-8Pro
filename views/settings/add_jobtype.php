    ...
    <div class="dashboard-ecommerce">
        <div class="container-fluid dashboard-content ">
            ...
            <div class="card editViewLeadClass1">
                <div class="custom-card"><h5 class="card-header"> Create New Job Type</h5> </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6 offset-lg-3">
                            <?php $this->load->helper("form"); ?>
                            <form role="form" id="addJobType" action="<?php echo base_url() ?>addJobType" method="post" role="form">
                                <div class="form-row">
                                    <div class="col-xl-10 offset-xl-1 mb-4">
                                        <label for="jobType">Job Type Name*</label>
                                        <input type="text" class="form-control required" value="<?php echo set_value('jobType'); ?>" id="jobType" name="jobType" maxlength="128" placeholder="">
                                    </div>
                                    <div class="col-xl-10 offset-xl-1 mb-4">
                                        <label for="color"> Color *</label>
                                        <div id="cp2" class="input-group colorpicker-component"> 
                                            <input type="text" value="#ff7b34" class="form-control required" id="color" name="color" maxlength="128" placeholder=""/> 
