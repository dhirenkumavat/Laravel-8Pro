        ...
        <!-- Filter Criteria Form start -->
         ...
         <div class="row">
            ...
            <div class="card editViewLeadClass">
                ...
                <div class="custom-card"><h5 class="card-header"> Create New Email Template
                </h5>
            </div>
                    <div class="card-body">
                        <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            ...
                            <form role="form" id="addEmailTemplate" action="<?php echo base_url() ?>addNewEmailTemplate" method="post" role="form">
                                <div class="form-row">
