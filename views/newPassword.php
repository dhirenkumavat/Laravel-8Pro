...
<html>
  <head>
    ...
    <title>Breathe Easy | Reset Password</title>
    ...
    <div class="login-box">
      ...
      <div class="login-box-body">
        <div class="forgotPasslogo">
             <img class="logoforgotiocn" src="<?php echo base_url(); ?>assets/images/am_logo.png">
        </div>
        ...
        <form action="<?php echo base_url(); ?>createPasswordUser" method="post">
          ...
          <div class="row">
           <div class="col-xs-12 text-center simplifylogin-btn">
